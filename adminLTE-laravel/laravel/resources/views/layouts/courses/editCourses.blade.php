                      ...
                      <div class="card-body">
                        <form id="editCourseForm" action="{{ route('courses.update', ['id' => $course->course_id]) }}" method="POST">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="course_name" name="course_name" value="{{ htmlspecialchars($course->course_name, ENT_QUOTES, 'UTF-8') }}" required>
                              </div>
                              <div class="form-group">
                                  <label for="description">Description</label>
                                  <textarea class="form-control" id="description" name="description">{{ htmlspecialchars($course->description, ENT_QUOTES, 'UTF-8') }}</textarea>
                              </div>
                              <div class="form-group">
                                  <label for="created_by">Created By (User ID)</label>
                                  <input type="text" class="form-control" id="created_by" name="created_by" value="{{ htmlspecialchars($course->created_by, ENT_QUOTES, 'UTF-8') }}" readonly>
                              </div>
